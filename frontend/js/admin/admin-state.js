...
let dispatchAlternativeRouteLayerGroup = null;
...
const dispatchLiveNavigationCache = new Map();
...
let dispatchLiveGuideRequestTimer = null;
let dispatchLiveGuideAbortController = null;
let dispatchLiveGuideGeneration = 0;
let dispatchLiveGuideTargetSignature = "";
let dispatchLiveGuidePendingSignature = "";
let dispatchLiveGuideLastStart = null;
let dispatchLiveGuideCoordinates = [];
let dispatchLiveGuideAlternativeCoordinates = [];
let dispatchLiveGuideAlternativeRouteCount = 0;
...
let dispatchLiveGuideLastRequestSucceeded = null;
let dispatchLiveGuideLastOriginAt = null;
let dispatchLiveGuideMovedMeters = null;
...
let dispatchActiveRouteTicketId = null;
let dispatchActiveRouteSessionId = null;
let dispatchActiveRouteMarkerSignature = "";
